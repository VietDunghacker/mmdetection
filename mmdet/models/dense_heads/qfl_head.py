...
from mmdet.core import (anchor_inside_flags, build_assigner, build_sampler,
 	 	 	 	 	 	images_to_levels, multi_apply, multiclass_nms, bbox_overlaps,
 	 	 	 	 	 	reduce_mean, unmap)
...
class QFLHead(AnchorHead):
 	...
 	def __init__(self,
 	 	...
 	 	super(QFLHead, self).__init__(num_classes, in_channels, **kwargs)
 	...
 	def loss_single(self, anchors, cls_score, bbox_pred, labels,
 	 	...
 	 	if len(pos_inds) > 0:
 	 	 	...
 	 	 	if self.score_weighting:
 	 	 	 	...
 	 	 	 	weight_targets = torch.ones_like(pos_bbox_pred[:,0])
