...
class BVRHead(BaseDenseHead, BBoxTestMixin):
	...
	def forward(self, feats):
		...
		if self.cls_keypoint_cfg['with_relation']:
			cls_feats = self._apply_relation(cls_feats, cls_feats, keypoint_scores, keypoint_offsets, self.cls_keypoint_cfg['keypoint_types'], self.cls_transformer)
		if self.reg_keypoint_cfg['with_relation']:
			reg_feats = self._apply_relation(reg_feats, reg_feats, keypoint_scores, keypoint_offsets, self.reg_keypoint_cfg['keypoint_types'], self.reg_transformer)
	...
	def loss(self,
		...
		keypoint_loss = self.keypoint_head.loss_multihead(keypoint_scores, keypoint_offsets, gt_bboxes, gt_labels, img_metas)
