...
class CentripetalHead(CornerHead):
	...
	def init_weights(self):
		...
		for i in range(self.num_feat_levels):
			...
			normal_init(self.tl_guiding_shift[i], std=0.01)
			normal_init(self.br_guiding_shift[i], std=0.01)
			normal_init(self.tl_centripetal_shift[i], std=0.01)
			normal_init(self.br_centripetal_shift[i], std=0.01)
