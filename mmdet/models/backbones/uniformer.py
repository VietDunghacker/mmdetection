...
class UniFormer(BaseModule):
	...
	"""
	def __init__(self, layers=[3, 4, 8, 3], in_chans=3, embed_dim=[64, 128, 320, 512],
				 ...
				 use_checkpoint=False, out_indices=(0,1,2,3), windows=False, hybrid=False, window_size=14, pretrained=None, init_cfg=None):
		"""
		Args:
