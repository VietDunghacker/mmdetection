...
from mmdet.datasets.api_wrappers import COCO, COCOeval, COCOevalMP, USBeval
            ...
            if metric == 'proposal':
                ...
                if self.classwise:  # Compute per-category AP
                    ...
                    for idx, cat_id in enumerate(self.cat_ids):
                        ...
                        olrp = coco_eval.eval['olrp'][idx, 0, -1]
                        olrp = olrp[olrp > -1]
                        ...
                        eval_results[f'{nm["name"]}_olrp'] = round(ap, 4)
