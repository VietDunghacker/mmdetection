...
model = dict(
	...
	backbone=dict(
		...
		patch_norm=True,
		out_indices=(1, 2, 3),
		pretrained="/gdrive/My Drive/checkpoints/elsa_swin_base_224.pth",
		use_checkpoint=True),
	neck=[
		dict(
			type='BiFPN',
...
albu_train_transforms = [
	dict(type='ShiftScaleRotate', shift_limit=0.1, scale_limit=0.1, rotate_limit=10, interpolation=1, p=0.5, border_mode = 0),
